...
export class CotizadorPage implements OnInit, OnDestroy {
    ...
    this.subscription = this.ilsAdminProvider.currentData.subscribe((data) => {
      ...
      if (data == 'cotizador') {
        this.zone.run(() => {
          ...
          this.actualYYYY = null;
          this.yyyySalida = null;
          ...
          this.pruebaSalida = null;
          this.pruebaLlegada = null;
          this.salidaApi = null;
          ...
          this.ionViewDidLoad();
          console.log('actualizacion forzada');
        })
      }
    });
  }
  ...
  ngOnDestroy() {
    ...
    this.subscription.unsubscribe('cotizador');
  }
